...
- **Cooling inserts in [plastic mould tooling](/capabilities/plastic-moulds/).** Beryllium-copper alloys are used for inserts near thin ribs, deep cores and other spots where the steel can't pull heat out fast enough on its own. BeCu tracks the copper market, so a mould with several such inserts costs more to build than it did in July.
- **Guide bushings and wear components in [press tools](/capabilities/press-tools/) and [jig fixtures](/capabilities/jig-fixtures/).** Phosphor bronze and other bronze alloys are standard for guide bushes, wear plates and some bearing surfaces in die sets and fixtures — again, copper-linked.
